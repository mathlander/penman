                        ...
                        <div style={{ display: (this.state.isEditing ? 'block' : 'none') }}>
                            <form>
                                <div className="input-field">
                                    <input id={`personification-form-first-name-${personificationId}`} name={`personification-form-first-name-${personificationId}`} type="text" className="validate" onChange={this.handleFirstNameChange} value={this.state.firstName} required autoFocus />
                                    <label htmlFor={`personification-form-first-name-${personificationId}`}>First Name</label>
                                </div>
                                <div className="input-field">
                                    <input id={`personification-form-middle-name-${personificationId}`} name={`personification-form-middle-name-${personificationId}`} type="text" className="validate" onChange={this.handleMiddleNameChange} value={this.state.middleName} required autoFocus />
                                    <label htmlFor={`personification-form-middle-name-${personificationId}`}>Middle Name</label>
                                </div>
                                <div className="input-field">
                                    <input id={`personification-form-last-name-${personificationId}`} name={`personification-form-last-name-${personificationId}`} type="text" className="validate" onChange={this.handleFirstNameChange} value={this.state.lastName} required autoFocus />
                                    <label htmlFor={`personification-form-last-name-${personificationId}`}>Last Name</label>
                                </div>
                                <div className="input-field">
                                    <input id={`personification-form-birthday-${personificationId}`} type="text" className={`datepicker datepicker-personification-${this.props.personification.personificationId}-birthday`} value={this.state.birthday.toDateString()} required />
